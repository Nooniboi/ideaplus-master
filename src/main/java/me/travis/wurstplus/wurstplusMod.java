...
public class wurstplusMod {
    ...
    public static final String MODID = "ideaplus";
    public static final String MODNAME = "Idea+";
    public static final String MODVER = "rb1.2.1";

    public static final String wurstplus_HIRAGANA = "Idea+";
    public static final String wurstplus_KATAKANA = "Idea+";
    public static final String wurstplus_KANJI = "Idea+";
    ...
    public void init(FMLInitializationEvent event) {
        ...
        wurstplusMod.log.info("IdeaPlus Mod initialized!\n");
    }
