...
public class AutoEZ extends Module {
    ...
    private void doAnnounce(String name) {
        ...
        if (ModuleManager.getModuleByName("Auto32k").isEnabled()) {
            message.append("Fastest AuTo32k in the EAST, brought to you by ");
        }
        else if (this.toxicMode.getValue().booleanValue()) {
            message.append("lol u suck. u got ezed by the best in the game with ");
        } else {
            message.append("haha bad. u wish u had ");
        }
        message.append("Idea+");
