...
@Module.Info(name = "Crystal Aura1", category = Module.Category.AURAS)
public class AutoCrystal extends Module {
  ...
  protected void onEnable() {
    Command.sendChatMessage("we \u00A7l\u00A72placing\u00A7r");
    if (mc.player == null) {
      this.disable();
      return;
    }
  ...
  public void onDisable() {
    this.renderBlock = null;
    Command.sendChatMessage("we aint \u00A7l\u00A74placing\u00A7r no more");
    resetRotation();
  }
